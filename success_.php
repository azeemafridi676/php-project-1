...
if (strpos($_SERVER['REQUEST_URI'], 'prodId=34569') !== false) {
    ...
    if (isset($_SESSION['upsellDoubleProductID'])) {
        ...
        */
        include_once __DIR__ . '/api/config_.php';
        $UpsellProdId = NULL;
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php
                            $cardstring = isset($_SESSION['credit_card_number']) ? getTruncatedCCNumber($_SESSION['credit_card_number'])  : '';
                            ?>
                            <td>Card :
                                <?php
                                if (!empty($cardstring)) {
                    ...
                    <tfoot style="background: #dff4fd">
                        ...
                        <tr>
                            ...
                            <td id="foter" class="total">
                                <strong>
                                    <?php
                                        // $totalAmount = json_decode($_SESSION['orderDetails'], true)['Transaction']['OrderInfo']['TotalAmount'];
                                        echo $totalAmount;
                                    ?>
                                </strong>
                            </td>
