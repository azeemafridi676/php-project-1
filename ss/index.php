    ...
    <div class="banner dsplay">
        <div class="container position bdinpad equalheight">
            <div class="col-7 text-ceter equalheight_content ">
			 <h1 class="bdhding_main" style="color:#ff0000">Subscribe & Save<br />
                   </h1><br/>
        ...
        <div class="container">
            ...
            <div class="prodBox">
                <div class="prodbox-row">
                    ...
                    <div class="clearall"></div>
                    <a href="javascript:void(0)" data-id="1" class="small_btn order-btn">Subscribe & Save</a>
                </div>
                ...
                <div class="prodbox-row">
                    ...
                    <div class="clearall"></div>
                    <a href="javascript:void(0)" data-id="2" class="small_btn order-btn">Subscribe & Save</a>
                </div>
                ...
                <div class="prodbox-row">
                    ...
                    <div class="clearall"></div>
                    <a href="javascript:void(0)" data-id="3" class="small_btn order-btn">Subscribe & Save</a>
                </div>
