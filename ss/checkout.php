...
<button type="submit" class="medium_btn">Subscribe & Save Now</button>

                        <div class="agreeTerms chk_1">
                            <input type="checkbox" name="agree" id="agree" value="Y" class="chk radio" required>
                            I am at least 18 years of age and agree to the <a href="terms.php" target="_blank">Terms & Conditions</a> and <a href="privacy.php" target="_blank">Privacy Policy </a>. I understand that I will be billed the price above with a new product shipped approximately every 30 days under the subscribe & 
							save option. 
                        </div>
                        <div class="agreeTerms chk_1" style="display:none">
						 
                            <input type="checkbox" value="1" name="is_reaccouring" id="is_reaccouring" checked>
                            Subscribe and save
                        </div>
