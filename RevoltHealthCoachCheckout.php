            ...
            <div class="bg-rounded">
                ...
                <div class="lft-chk">
                    ...
                    <form role="form" id="checkoutForm2" method="post">
                        <input type="hidden" id="productId" name="productId" value="34569" />
                        ...
                        <button type="submit" onclick="submitBtnFunction()" class="medium_btn">Purchase Now</button>
        ...
        $(document).ready(function() {
            ...
            if (selc_prc == prc_four) {
                if (is_reaccouring) {
                    ...
                    $("#sub-prodnm").html("Hire A Revolt Health Coach");
                    $("#sub-tot").html('$99.95');
                    $("#shp_hnd").html('$0.00');
                    $("#productId").val('34732');
                    $("#prod-image").attr("src", "images/check.png");
                    total = 99.95;
                }
            }
