...
<style>
    ...
    .fixed {
        ...
        background: linear-gradient(to bottom, #9B9696 30%, #333333 70%);
        overflow: hidden;
        padding: 20px;
        z-index: 1004;
        border-radius: 15px;
    ...
    <div class="upsell-modal">
        <div class="modal-container">
            <div class="modal-image">
                <img src="images/product<?= isset($_GET['pidx']) ? $_GET['pidx'] : '' ?>.png">
            </div>
...
<script>
    ...
    // got a product id based on the url
    ...
    $(document).ready(function() {
            ...
            $("#checkoutForm2").on("submit", function(e) {
                ...
                // if global variable poup modal is set to yes, show the overlay and modal for double 
                // product upsell 
                ...
                var selc_prc = urlParams.get('doubleproduct');

                var PopupModal = "no";
                if (selc_prc !== 'no') {
                    if (<?php echo isset($GLOBALS['PopupModal']) ? 'true' : 'false' ?>) {
                    PopupModal = "<?php echo $GLOBALS['PopupModal'] ?>";
                }    
                }
                ...
                if (PopupModal === "yes") {
                    ...
                    if upsell modal is accepted then this below function will push addition data with form i.e. product id. the ajax then goto createOrder.php and that id is used in createorder.php and success.php to complete upsell modal. other orders are also executed in createorder.php.
                    ...
                    */
                    ...
                    //if upsell is rejected that no additional data is added.
                    ...
                    // if the popup modal global variable value is not yes than no popup will appear or execute.
