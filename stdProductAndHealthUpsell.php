                ...
                <form role="form" id="checkoutForm2" method="post">
                    ...
                    <div class="agreeTerms chk_1">
                        <label>
                            ...
                            I am at least 18 years of age and agree to these <a href="terms.php" target="_blank">Terms & Conditions</a> and <a href="privacy.php" target="_blank">Privacy Policy </a>.
                        </label>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        if (selc_prc == prc_one) {
                ...
                subTotal1 = parseFloat($('#sub-tot').html().replace('$', ''));
                subTotal2 = parseFloat($('#sub-tot2').html().replace('$', ''));
                total = subTotal1 + subTotal2;
                $(".tot-prc").html(total);
                $(".tot-prc2").html("$136.08");
                $(".tot-prc3").html("$99.95");
...
<script>
    ...
    $(document).ready(function() {
        ...
        var selc_prc = urlParams.get('checked');

        if (selc_prc == 'checked') {
            
            /* Add event listeners to the buttons */
            document.querySelector(".accept").addEventListener("click", hidePopupAndProcessUpsell);
            document.querySelector(".reject").addEventListener("click", hidePopup);
